...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@T_Y_E_X"))
...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@UI_VM"))
    except BaseException:
        pass
...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@CB_LQ"))
    except BaseException:
        pass  
...
async def _(event):
    ...
    joinu = await sython1(JoinChannelRequest('T_Y_E_X'))
